...
worker.onmessage = function(msgEvent){
  ...
  switch(data.type){
    case "startServer":
      worker.postMessage({type:"serverStartText", text:"Loading definitions...", tip:"This might take a while depending on device and internet speed"})
...
function getCrptFunction(){
    ...
    const spawnBot = (loc = null) => {
        ...
        if (room.gameMode === "tdm") {
            let team = c.serverName === "Infiltration" ? 20 : c.serverName === "Private Custom" ? 3 : room.nextTagBotTeam.shift() || getTeam(0);
            o.team = -team;
    ...
    class Skill {
        ...
        update() {
            ...
            this.str = apply(4, attrib[skcnv.str]);
                    ...
                    if (this.cycle >= 1) {
                        ...
                        if (shootPermission && this.cycle >= 1) {
                            /*
                                ...
                                */
                            if (c.DO_BASE_DAMAGE && this.body.type !== "wall" && this.body.isInMyBase()) {
                    ...
                    if (goAhead) {
                        ...
                        if (nIsFirmCollide < 0) {
                            ...
                            let spring = 2 * Math.sqrt(savedHealthRatio._me * savedHealthRatio._n) / room.speed,
                                ...
                                modifiers = {
                                    _me: c.KNOCKBACK_CONSTANT * my.pushability / my.mass * deathFactor._n * 2.25,
                                    _n: c.KNOCKBACK_CONSTANT * n.pushability / n.mass * deathFactor._me * 2.25
                                };
